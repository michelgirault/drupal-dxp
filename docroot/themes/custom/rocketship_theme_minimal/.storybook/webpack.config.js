    ...
    use: [
      {
        ...
        options: {
          twigOptions: {
            namespaces: {
              "rocketship-theme-minimal-atoms": path.resolve(
                __dirname,
                '../',
                'components/00-theme/01-atoms'
              ),
              "rocketship-theme-minimal-molecules": path.resolve(
                __dirname,
                '../',
                'components/00-theme/02-molecules',
              ),
              "rocketship-theme-minimal-organisms": path.resolve(
                __dirname,
                '../',
                'components/00-theme/03-organisms',
              ),
              "rocketship-theme-minimal-templates": path.resolve(
                __dirname,
                '../',
                'components/00-theme/04-templates',
              ),
              "rocketship-theme-minimal-pages": path.resolve(
                __dirname,
                '../',
                'components/00-theme/05-pages',
              ),
              "rocketship-theme-minimal-cb-molecules": path.resolve(
                __dirname,
                '../',
                'components/01-content-blocks/02-molecules',
              ),
              "rocketship-theme-minimal-cb-organisms": path.resolve(
                __dirname,
                '../',
                'components/01-content-blocks/03-organisms',
              ),
              "rocketship-theme-minimal-news-molecules": path.resolve(
                __dirname,
                '../',
                'components/02-features/f001-news/02-molecules',
              ),
              "rocketship-theme-minimal-blog-molecules": path.resolve(
                __dirname,
                '../',
                'components/02-features/f002-blog/02-molecules',
              ),
              "rocketship-theme-minimal-blog-organisms": path.resolve(
                __dirname,
                '../',
                'components/02-features/f002-blog/03-organisms',
              ),
              "rocketship-theme-minimal-office-atoms": path.resolve(
                __dirname,
                '../',
                'components/02-features/f006-office/01-atoms',
              ),
              "rocketship-theme-minimal-office-molecules": path.resolve(
                __dirname,
                '../',
                'components/02-features/f006-office/02-molecules',
              ),
              "rocketship-theme-minimal-realisations-molecules": path.resolve(
                __dirname,
                '../',
                'components/02-features/f007-realisation/02-molecules',
              ),
              "rocketship-theme-minimal-service-molecules": path.resolve(
                __dirname,
                '../',
                'components/02-features/f008-service/02-molecules',
              ),
              "rocketship-theme-minimal-product-molecules": path.resolve(
                __dirname,
                '../',
                'components/02-features/f009-product/02-molecules',
              ),
              "rocketship-theme-minimal-job-molecules": path.resolve(
                __dirname,
                '../',
                'components/02-features/f012-job/02-molecules',
              ),
              "rocketship-theme-minimal-event-molecules": path.resolve(
                __dirname,
                '../',
                'components/02-features/f014-event/02-molecules',
              ),
              "rocketship-theme-minimal-event-organisms": path.resolve(
                __dirname,
                '../',
