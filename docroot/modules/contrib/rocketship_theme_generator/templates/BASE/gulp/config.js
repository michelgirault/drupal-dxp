...
let config = {
  ...
  themeName: themeName,
  colors: 'components/00-theme/00-base/00-config/00-variables/_vars-00-colors.scss',
  ...
  css: {
    src: ['components/00-theme/**/*.scss',
      ...
      'components/02-features/f007-realisation/**/*.scss',
  ...
  js: {
    src: ['components/00-theme/00-base/**/*.js',
      ...
      'components/02-features/f007-realisation/**/*.js',
