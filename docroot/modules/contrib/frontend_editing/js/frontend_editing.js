  ...
  Drupal.behaviors.toggleFrontendEditing = {
    attach: function (context, settings) {
      ...
      const isGin = function () {
        if (document.querySelector('.gin--vertical-toolbar')) {
          return true;
        }
        else {
          return false;
      ...
      const addButtonGin = function (enabled) {
        ...
        // Add to toolbar
        const siblingLi = document.querySelector('.gin--vertical-toolbar #toolbar-item-administration-tray .menu-item__spacer');
